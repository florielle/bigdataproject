'''
This script will count the difference in days between the start date and the 
end date for all rows where the start time is '24:00:00' and print out the rows 
where the difference in days is 0.
'''
...
if __name__ == "__main__":
    ...
    .map(lambda x: (delta_days(x[1][0], x[1][2]), x[1]))\
